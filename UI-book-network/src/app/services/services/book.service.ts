...
import { approveBorrowBook } from '../fn/book/approve-borrow-book';
import { ApproveBorrowBook$Params } from '../fn/book/approve-borrow-book';
...
export class BookService extends BaseService {
  ...
  /** Path part for operation `approveBorrowBook()` */
  static readonly ApproveBorrowBookPath = '/books/borrow/return/approve/{book-id}';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `approveBorrowBook()` instead.
   *
   * This method doesn't expect any request body.
   */
  approveBorrowBook$Response(params: ApproveBorrowBook$Params, context?: HttpContext): Observable<StrictHttpResponse<number>> {
    return approveBorrowBook(this.http, this.rootUrl, params, context);
  }

  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `approveBorrowBook$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  approveBorrowBook(params: ApproveBorrowBook$Params, context?: HttpContext): Observable<number> {
    return this.approveBorrowBook$Response(params, context).pipe(
      map((r: StrictHttpResponse<number>): number => r.body)
    );
  }
